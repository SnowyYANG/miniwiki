<?php
  ...
  class MW_Request {
    ...
    function MW_Request() {
      $this->page_name = (isset($_REQUEST[MW_REQVAR_PAGE_NAME]) ? $_REQUEST[MW_REQVAR_PAGE_NAME] : MW_DEFAULT_PAGE_NAME);
      $this->action = (isset($_REQUEST[MW_REQVAR_ACTION]) ? $_REQUEST[MW_REQVAR_ACTION] : MW_DEFAULT_ACTION);
      $this->revision = (isset($_REQUEST[MW_REQVAR_REVISION]) ? $_REQUEST[MW_REQVAR_REVISION] : MW_REVISION_HEAD);
      $this->content = (isset($_REQUEST[MW_REQVAR_CONTENT]) ? $_REQUEST[MW_REQVAR_CONTENT] : NULL);
      $this->message = (isset($_REQUEST[MW_REQVAR_MESSAGE]) ? $_REQUEST[MW_REQVAR_MESSAGE] : NULL);
      $this->preview = (isset($_REQUEST[MW_REQVAR_PREVIEW]) ? $_REQUEST[MW_REQVAR_PREVIEW] : NULL);
      $this->old_user = (isset($_REQUEST[MW_REQVAR_OLD_USER]) ? $_REQUEST[MW_REQVAR_OLD_USER] : NULL);
      $this->user = (isset($_REQUEST[MW_REQVAR_USER]) ? $_REQUEST[MW_REQVAR_USER] : NULL);
      $this->pass = (isset($_REQUEST[MW_REQVAR_PASS]) ? $_REQUEST[MW_REQVAR_PASS] : NULL);
      $this->sourcefile = (isset($_FILES[MW_REQVAR_SOURCEFILE]) ? $_FILES[MW_REQVAR_SOURCEFILE] : NULL);
      $this->destfile = (isset($_REQUEST[MW_REQVAR_DESTFILE]) ? $_REQUEST[MW_REQVAR_DESTFILE] : NULL);
